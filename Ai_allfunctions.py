...
def final_data():
    ...
    while keep_talking == 1:
        ...
        if ((type(response_js) != ' EMS CALLS')&((response_js('name')&response_js('type')&response_js('location')) != 0)):
            break
        else if (type(response_js) != ' EMS CALLS'):
    ...
    return df_information, response_js, df
