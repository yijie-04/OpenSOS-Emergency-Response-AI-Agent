...
from OpenSOSfunctions import final_suggestions, final_data
...
if __name__ == "__main__":
    ...
    input_keyInfo = f"Name: {response_js['name']}\nLocation: {response_js['type']}\nType: {response_js['location']}\nSymptoms: {response_js['symptoms']}"
